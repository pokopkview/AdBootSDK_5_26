...
public class AdRequest {
    ...
    public Uri toUri() {
        ...
        if (mAdBoot == null || mAdBoot.GetCUSTOMINFO() == null || mAdBoot.GetCUSTOMINFO().GetMAC() == null
            ...
            if (Debug)
                Log.d("i=" + MD5Util.GetMD5Code(mAdBoot.GetCUSTOMINFO().GetMAC().toUpperCase()));
        }
        ...
        if (Debug)
            Log.d("connection_type=" + PhoneManager.getInstance().GetConnectType().toString());
        ...
        if (Debug) Log.d("sdkversion=" + AdConfig.GetSDKVersion());
        switch (mAdMode.GetAD()) {
            ...
            case ADBOOT:
                ...
                if (mAdBoot == null || mAdBoot.GetCUSTOMINFO() == null || mAdBoot.GetCUSTOMINFO().GetDEVICETYPE() == null) {
                    ...
                    if (Debug)
                        Log.d("dt=" + Integer.toString(mAdBoot.GetCUSTOMINFO().GetDEVICETYPE().toInt()));
                }
                if (mAdBoot == null || mAdBoot.GetCUSTOMINFO() == null || mAdBoot.GetCUSTOMINFO().GetUSEMODE() == null) {
                    ...
                    if (Debug)
                        Log.d("up=" + Integer.toString(mAdBoot.GetCUSTOMINFO().GetUSEMODE().toInt()));
                }
                if (mAdBoot == null || mAdBoot.GetCUSTOMINFO() == null || mAdBoot.GetCUSTOMINFO().GetLICENSEPROVIDER() == null) {
                    ...
                    if (Debug)
                        Log.d("lp=" + Integer.toString(mAdBoot.GetCUSTOMINFO().GetLICENSEPROVIDER().toInt()));
                }
                ...
                if (mAdBoot == null || mAdBoot.GetCUSTOMINFO() == null) {
                    ...
                    if (Debug)
                        Log.d("ot=" + Integer.toString(mAdBoot.GetCUSTOMINFO().GetLastBootUpCount()));
                }
